...
namespace ZombiesMustDie
{
    public static class SoundExtension
    {
        ...
        public static int? PlayMusic(this SoundComponent soundComponent, int musicId, object userData = null)
        {
            ...
            s_MusicSerialId = soundComponent.PlaySound(AssetUtility.GetMusicAsset(drMusic.AssetName), "Music", 120, playSoundParams, null, userData);
        ...
        public static void Mute(this SoundComponent soundComponent, string soundGroupName, bool mute)
        {
            ...
            GameEntry.Setting.SetBool(Utility.Text.Format("Setting.{0}Muted", soundGroupName), mute);
        ...
        public static void SetVolume(this SoundComponent soundComponent, string soundGroupName, float volume)
        {
            ...
            GameEntry.Setting.SetFloat(Utility.Text.Format("Setting.{0}Volume", soundGroupName), volume);
            GameEntry.Setting.Save();
        }
    }
}
