...
namespace ZombiesMustDie
{
    public static class UIExtension
    {
        ...
        public static int? OpenUIForm(this UIComponent uiComponent, int uiFormId, object userData = null)
        {
            ...
            //!临时注释 return uiComponent.OpenUIForm(assetName, drUIForm.UIGroupName, Constant.AssetPriority.UIFormAsset, drUIForm.PauseCoveredUIForm, userData);
            return uiComponent.OpenUIForm(assetName, drUIForm.UIGroupName, 100, drUIForm.PauseCoveredUIForm, userData);
        }
