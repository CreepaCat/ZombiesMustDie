...
namespace ZombiesMustDie
{
    ...
    {
        private const string DataRowClassPrefixName = "ZombiesMustDie.DR";
        ...
        public static void LoadDataTable(this DataTableComponent dataTableComponent, string dataTableName, string dataTableAssetName, object userData)
        {
            ...
            //!临时注释 dataTable.ReadData(dataTableAssetName, Constant.AssetPriority.DataTableAsset, userData);
